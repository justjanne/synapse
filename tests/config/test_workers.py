...
class WorkerDutyConfigTestCase(TestCase):
    def _make_worker_config(self, worker_app: str, worker_name: Optional[str]) -> WorkerConfig:
        root_config = Mock()
    ...
    def test_old_configs_master(self) -> None:
        ...
        self.assertTrue(main_process_config._should_this_worker_perform_duty(
            {},
            "notify_appservices",
        ...
        self.assertFalse(main_process_config._should_this_worker_perform_duty(
            {
    ...
    def test_old_configs_appservice_worker(self) -> None:
        ...
        with self.assertRaises(ConfigError):
            ...
            self.assertFalse(appservice_worker_config._should_this_worker_perform_duty(
                {},
                "notify_appservices",
                "synapse.app.appservice",
                "notify_appservices_from_worker"
        ...
        self.assertTrue(appservice_worker_config._should_this_worker_perform_duty(
            {
                "notify_appservices": False,
            },
            "notify_appservices",
